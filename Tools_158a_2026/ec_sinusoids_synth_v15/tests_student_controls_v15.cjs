...
const gallery=boxes(main.patcher)['send-message-space-v15'].patcher;
...
assert.deepStrictEqual(boxes(read('Send_Message_Space_v15.maxpat').patcher)['live-controls'].patcher,space);
