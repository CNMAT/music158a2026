...
// v15 student-message controls. Indices are one-based, including hidden slots.
...
function partialget(channel,index){
    ...
    materialize(channel);
    var names=["Partial_Drift_current_v15","Partial_Amplitude_current_v15","Partial_Anchor_current_v15"];
