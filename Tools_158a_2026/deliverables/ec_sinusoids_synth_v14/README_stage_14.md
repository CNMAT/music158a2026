# ec_sinusoids_synth_v14

Open `_ec_sinusoids_synth_stage_14.maxpat`. Keep the entire folder together so its JavaScript helpers and stop-workspace abstractions resolve. This release uses the user-revised `ec_sinusoids_synth_v13(1).zip` as the baseline.
